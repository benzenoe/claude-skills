---
name: skills
description: Use this skill when the user types /skills or asks to see what skills are available in this environment. Lists all installed skills from ~/.claude/skills/.
---
...
- **Slash Command** — the `/name` value from the SKILL.md frontmatter
...
- A reminder that skills also activate automatically when you describe a task in plain English — no slash command needed
